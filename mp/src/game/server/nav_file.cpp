...
void CNavArea::Save( CUtlBuffer &fileBuffer, unsigned int version ) const
{
    ...
    //SURF_TODO: Search why for this too.
#ifdef CSTRIKE_DLL
...
*/
    ...
    // SURF_TODO: We don't know what is exactly this, needs investigation.
#ifdef CSTRIKE_DLL
    auto UnknownUnsignedChar = fileBuffer.GetUnsignedChar();
    Assert( UnknownUnsignedChar == 0 );
    DevMsg( "CNavArea::Load: %i %2X %i\n" , UnknownUnsignedChar , UnknownUnsignedChar , m_id);
#endif
